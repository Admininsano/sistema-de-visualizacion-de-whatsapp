import type { ParsedChat, ParsedMessage } from "./types.js";
...
function toIso(datePart: { day: string; month: string; year: string; hour: string; minute: string; meridiem?: string }) {
...
export function parseWhatsAppExport(source: string, sourceName = "chat") : ParsedChat {
